...
date_known: true
date_note: >
  Held May 9–10, 2022 — exactly 50 years to the day and hour of the Chinook crash.

location: Washington, DC; Vietnam Veterans Memorial Wall

contains:
  - slug: kutter-wolf
    name: Wolf D. Kutter
    role: >
      CO, D Co. 2/8 Cav (Skipper 6, 1971–72); ASA foreword author; resource panel.
      Led the effort to contact all 34 Gold Star families.
  - slug: adams-roy
    name: Roy Adams
    role: >
      Sgt. Cat Platoon; resource panel. Photographed the departure of CH-47A
      64-13157 on May 10, 1972 ("Skull Platoon Last Flight"). Attended as a
      surviving witness to the crash.

tagged:
  # D Co. KIA with existing profiles — add others as profiles are built
  - slug: rosenberg-kenneth
    name: CPT Kenneth Rosenberg
    note: Memorialized; CO D Co., killed in the May 10, 1972 Chinook crash
  - slug: aguilar-oscar
    name: SP4 Oscar Aguilar
    note: Memorialized; Skull Platoon, killed in the May 10, 1972 Chinook crash
...
related_events:
  - slug: chinook-crash-1972-05-10
    ...
    note: >
      50th anniversary memorial ceremony honoring the 34 soldiers killed in the
...
open_questions:
  - id: oq-01
    publish: true
    question: >
      If you attended the Never Forgotten 34 Memorial in Washington, DC on
      May 9–10, 2022, we would welcome your account of the event and any
      photographs you can share.
  - id: oq-02
    publish: true
    question: >
      Family members of any of the Never Forgotten 34 are part of the
      Angry Skipper family. If you are related to one of the fallen and
      would like to be connected, please reach out through the contribute form.
...
archivist_notes:
  ...
  notes: >
    Primary source: ASA Walking Point newsletter, Issue 20, January 2023.
    Contains full unit-attributed roster (D 2nd/8th, 362nd Aviation, 1st Signal
    Brig Aviation Detach., A 1st/12th Cav), resource panel identifications,
    and four Gold Star family testimonials (Howell, Rosenberg, Monteleone, Phillips).
    Roy Adams confirmed as photographer of the departure photo captioned
    "Skull Platoon Last Flight May 10, 1972."
    Peter Eldrige confirmed as Chairman of the Crash Investigation Board.
    Dr. John Osheroff confirmed as attending physician at the crash site.
    Tagged KIA list is partial — only soldiers with existing profile stubs are
    included. Add remaining 16 D Co. tagged entries as stubs are built.
---
